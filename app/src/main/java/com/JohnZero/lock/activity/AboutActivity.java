 ...
 * @date: 2020-09-11
 **/
public class AboutActivity extends BaseActivity implements View.OnTouchListener, GestureDetector.OnGestureListener{
    ...
    protected void initView() {
        ...
        headPhoto.setOnTouchListener(this);
        headPhoto.setLongClickable(true);
    }
